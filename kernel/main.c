...
void main() {
    ...
    writeByteInPort(0x3d4, 14); /* Requesting byte 14: high byte of cursor pos */
    /* Data is returned in VGA data register (0x3d5) */
    int position = readByteFromPort(0x3d5);
    position = position << 8; /* high byte */

    writeByteInPort(0x3d4, 15); /* requesting low byte */
    position += readByteFromPort(0x3d5);
